      ...
      <Header height={110} px="md" withBorder={true}>
        <Group position="apart" sx={{ height: '100%' }}>
          <Flex direction={'column'}>
            ...
            {/* TODO: Figure out how to update the role and club name based on what is selected */}
            <Title color='blue' order={4}>Admin</Title>
          </Flex>
          <Group
            sx={{ height: '100%' }}
            position="right"
          ...
          >
            ...
            <Link href="/applicant" className={classes.link}>
              <Text color="blue">Switch to Applicant Portal</Text>
            </Link>
